...
const std::unordered_map<int, std::string> cocoLabelsMap = {
    ...
    {10, "traffic light"}, {11, "fire hydrant"}, {12, "street sign"},
    {13, "stop sign"},     {14, "parking"},      {15, "bench"},
    ...
    {43, "tennis racket"}, {44, "bottle"},       {45, "plate"},
    {46, "wine glass"},    {47, "cup"},          {48, "fork"},
    ...
    {64, "potted plant"},  {65, "bed"},          {66, "mirror"},
    {67, "dining table"},  {68, "window"},       {69, "desk"},
