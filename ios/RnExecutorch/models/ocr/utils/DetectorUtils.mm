...
+ (NSArray <NSDictionary *>*)restoreBboxRatio:(NSArray <NSDictionary *>*)boxes usingRestoreRatio:(CGFloat)restoreRatio {
...
+ (CGFloat)calculateMinimalDistanceBetweenBox:(NSArray<NSValue *> *)box1 andBox:(NSArray<NSValue *> *)box2 {
...
+ (NSMutableArray<NSDictionary *> *)removeSmallBoxesFromArray:(NSArray *)boxes usingMinSideThreshold:(CGFloat)minSideThreshold maxSideThreshold:(CGFloat)maxSideThreshold {
 ...
 */
+ (NSArray<NSDictionary *> *)groupTextBoxes:(NSMutableArray<NSDictionary *> *)boxes
                            centerThreshold:(CGFloat)centerThreshold
                                   ...
                                   maxWidth:(int)maxWidth
{
  ...
  NSArray<NSDictionary *> *sortedBoxes = [mergedArray sortedArrayUsingComparator:^NSComparisonResult(NSDictionary *obj1, NSDictionary *obj2) {
