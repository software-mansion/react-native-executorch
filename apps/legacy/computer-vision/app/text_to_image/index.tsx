...
import { models, useTextToImage, TextToImageProps } from 'react-native-executorch/legacy';
    ...
    >
      ...
      >
          ...
          {model.isGenerating ? (
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.infoText}>
                This model generates images from text descriptions using a diffusion process. Type a
                prompt below and tap the send button to generate an image.
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={[styles.inputRow, { marginBottom: bottom || 12 }]}>
          ...
          />
          {model.isGenerating ? (
            <TouchableOpacity style={styles.sendButton} onPress={model.interrupt}>
