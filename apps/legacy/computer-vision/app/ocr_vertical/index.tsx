      ...
      <View style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          {imageUri && imageDimensions?.width && imageDimensions?.height ? (
            <ImageWithBboxes2
              ...
              imageUri={imageUri || require('../../assets/icons/executorch_logo.png')}
            />
          ) : (
            <Image
              style={styles.image}
        ...
        {!imageUri && (
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              This model reads vertical text (e.g. Japanese, Korean, Chinese columns) from images,
              returning each detected text region with its bounding box and confidence score. Pick
        ...
        {imageUri && inferenceTime !== null && results.length === 0 && (
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              The model did not find any vertical text in this image. Try an image containing
              vertical Japanese, Korean, or Chinese text.
            </Text>
          </View>
        )}
        {results.length > 0 && (
