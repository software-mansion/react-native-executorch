...
export default function ObjectDetectionScreen() {
  ...
  const [selectedModel, setSelectedModel] = useState<ObjectDetectionModelSources>(
    objectDetection.rf_detr_nano()
  );
        ...
        {!imageUri && (
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              This model detects objects in an image and draws bounding boxes around them with class
              labels and confidence scores. Pick an image from your gallery or take one with your
