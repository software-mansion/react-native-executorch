        ...
        {!imageUri && (
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              This model applies artistic styles to your images, transforming them to look like
              famous paintings. Pick an image from your gallery or take one with your camera to get
              started.
            </Text>
          </View>
        )}
