...
export default function ClassificationScreen() {
  const [selectedModel, setSelectedModel] = useState<ClassificationModelSources>(
    ...
    <ScreenWrapper>
      ...
      <View style={styles.imageContainer}>
        <Image
          style={styles.image}
          resizeMode="contain"
          source={imageUri ? { uri: imageUri } : require('../../assets/icons/executorch_logo.png')}
        />
        {!imageUri && (
          <View style={styles.infoContainer}>
            <Text style={styles.infoTitle}>Image Classification</Text>
            <Text style={styles.infoText}>
              This model analyzes an image and returns the top 10 most likely labels with confidence
              scores. Use the gallery or camera icons below to pick an image, then tap the button to
              run the model.
            </Text>
          </View>
        )}
