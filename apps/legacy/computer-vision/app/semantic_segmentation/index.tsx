...
export default function SemanticSegmentationScreen() {
  ...
  const [selectedModel, setSelectedModel] = useState<SemanticSegmentationModelSources>(
      ...
      <View style={styles.imageCanvasContainer}>
        <View style={styles.imageContainer}>
          <Image
            ...
            resizeMode="contain"
            source={
              imageUri ? { uri: imageUri } : require('../../assets/icons/executorch_logo.png')
            }
          />
          {!imageUri && (
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.infoText}>
                This model assigns a class label to every pixel in an image, painting each region
                with a distinct color. Pick an image from your gallery or take one with your camera
                to get started.
              </Text>
            </View>
          )}
