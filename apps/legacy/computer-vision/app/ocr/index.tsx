...
import { models, useOCR, OCRProps } from 'react-native-executorch/legacy';
...
export default function OCRScreen() {
  ...
  const [selectedModel, setSelectedModel] = useState<OCRModelSources>(ocr({ language: 'en' }));
        ...
        {!imageUri && (
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              This model reads and extracts text from images, returning each detected text region
              with its bounding box and confidence score. Pick an image from your gallery or take
