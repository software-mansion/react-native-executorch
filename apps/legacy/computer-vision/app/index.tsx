  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('vision_camera/')}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('pose_estimation/')}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('ocr_vertical/')}>
          <Text style={styles.buttonText}>OCR Vertical</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('style_transfer/')}>
          <Text style={styles.buttonText}>Style Transfer</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('text_to_image/')}>
