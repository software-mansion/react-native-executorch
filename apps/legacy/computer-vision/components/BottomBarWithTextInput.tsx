...
export const BottomBarWithTextInput = ({
  ...
  if (!showTextInput) {
    if (isGenerating) {
      return (
        <TouchableOpacity style={styles.button} onPress={stopModel} disabled={!isReady}>
  ...
  return (
    ...
    >
      ...
      <View style={styles.stepsContainer}>
        <Text style={[styles.text, keyboardVisible && styles.textWhite]}>Steps: {numSteps}</Text>
        <View style={styles.stepsButtons}>
          <TouchableOpacity style={[styles.button, styles.iconButton]} onPress={decreaseSteps}>
            <Text style={styles.buttonText}>-</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.button, styles.iconButton]} onPress={increaseSteps}>
            <Text style={styles.buttonText}>+</Text>
          </TouchableOpacity>
        </View>
      </View>
