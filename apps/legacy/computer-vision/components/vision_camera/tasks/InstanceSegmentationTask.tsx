...
import { buildDisplayInstances, DisplayInstance } from '../../../components/ImageWithMasks';
...
export default function InstanceSegmentationTask({
  ...
  const frameOutput = useFrameOutput({
    ...
    onFrame: useCallback(
      ...
      [instSegRof, frameKillSwitch, updateInstances, activeModel, cameraPositionSync]
    ),
  });
    ...
    <View style={StyleSheet.absoluteFill} pointerEvents="none">
      ...
      {instances.map((inst, i) => {
        ...
        return (
          ...
          >
            <View style={[styles.bboxLabel, { backgroundColor: labelColorBg(label) }]}>
