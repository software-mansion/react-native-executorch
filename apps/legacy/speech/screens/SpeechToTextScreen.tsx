        ...
        >
          ...
          <View style={styles.statusContainer}>
            ...
            {transcriptionTime !== null && (
              <Text style={styles.statsText}>Transcription: {transcriptionTime} ms</Text>
            )}
          </View>
            ...
            >
              {displayData ? (
                ...
                <Text style={styles.placeholderText}>
                  {liveTranscribing ? 'Listening...' : 'No transcription yet...'}
                </Text>
              )}
            </ScrollView>
          </View>
          ...
          <View style={styles.inputContainer}>
            <View style={styles.urlTranscriptionContainer}>
              ...
              <TouchableOpacity
                ...
                style={[styles.urlTranscriptionButton, !readyToTranscribe && styles.disabled]}
              >
            ...
            {liveTranscribing ? (
              ...
              <View style={styles.buttonRow}>
                ...
                >
                  ...
                  <Text style={styles.buttonText}>{isSimulator ? 'No Mic' : 'Start Live'}</Text>
                </TouchableOpacity>
                  ...
                  <View style={styles.vadTextContainer}>
                    <Text
                      style={[
                        ...
                        useVAD ? styles.vadButtonLabelActive : styles.vadButtonLabelInactive,
                      ]}
                    >
                      VAD
                    </Text>
                    <Text
                      style={[
                        ...
                        useVAD ? styles.vadButtonStateActive : styles.vadButtonStateInactive,
                      ]}
                    >
                      {useVAD ? 'ON' : 'OFF'}
                    </Text>
