...
import { models, useTextToSpeech, TextToSpeechModelConfig } from 'react-native-executorch/legacy';
...
export const TextToSpeechScreen = ({ onBack }: { onBack: () => void }) => {
  const [selectedSpeaker, setSelectedSpeaker] = useState<TextToSpeechModelConfig>(
    tts.en_us.heart()
  );
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={styles.buttonContainer}>
            ...
            >
              <FontAwesome name={isPlaying ? 'volume-up' : 'play'} size={20} color="white" />
              <Text style={styles.buttonText}>{isPlaying ? 'Playing...' : 'Generate & Play'}</Text>
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
      </SafeAreaView>
