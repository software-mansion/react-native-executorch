...
export const QUESTIONS = [
  ...
  },
  {
    ...
    a: ['Thomas Edison', 'Alexander Graham Bell', 'Nikola Tesla', 'Guglielmo Marconi'],
    c: 1,
  ...
  },
  {
    ...
    a: ['Andes', 'Himalayas', 'Kilimanjaro is a standalone mountain', 'Rockies'],
    c: 2,
  ...
  },
  {
    ...
    a: ['Herman Melville', 'Ernest Hemingway', 'F Scott Fitzgerald', 'Mark Twain'],
    c: 0,
