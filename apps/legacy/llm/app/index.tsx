  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('multimodal_llm/')}>
          <Text style={styles.buttonText}>Multimodal LLM (VLM)</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => router.navigate('privacy_filter/')}>
