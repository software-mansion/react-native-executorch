...
function LLMScreen() {
  ...
  const [selectedModel, setSelectedModel] = useState<LLMModelSources>(models.llm.qwen3_1_7b());
  ...
  useEffect(() => {
    ...
    if (!llm.isGenerating && lastMessage?.role === 'assistant') {
      try {
        const formattedOutput = fixAndValidateStructuredOutput(lastMessage.content, responseSchema);
          ...
          {llm.messageHistory.length ? (
            ...
            <View style={styles.helloMessageContainer}>
              ...
              <Text style={styles.bottomHelloText}>
                I can parse user's questions! Introduce yourself, ask questions and offer a price
                for some product.
              </Text>
