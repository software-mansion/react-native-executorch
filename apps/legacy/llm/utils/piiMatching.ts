import { PiiEntity } from 'react-native-executorch/legacy';
 ...
 */
export function matchEntities(source: string, entities: PiiEntity[]): EntityMatch[] {
 ...
 */
export function buildSegments(source: string, matches: EntityMatch[]): Segment[] {
