...
import { Message } from 'react-native-executorch/legacy';
    ...
    <View style={styles.userMessageWrapper}>
      ...
      <View style={styles.userMessageBubble}>
        ...
        {message.audioWaveform && (
          <AudioWaveform buffer={message.audioWaveform} style={styles.userMessageWaveform} />
        )}
        <MarkdownComponent text={message.content} />
      </View>
    </View>
...
const CloseButton = ({ deleteMessage, role }: { deleteMessage: () => void; role: string }) => {
  return (
    <TouchableOpacity
      style={[
        styles.closeButton,
