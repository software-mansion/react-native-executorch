  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      link: {
        ...
        title: 'Benchmarks',
        description:
          'On-device latency, memory and download size for every published model variant.',
      },
      items: [{ type: 'autogenerated', dirName: '04-benchmarks' }],
    },
    {
      type: 'category',
      label: 'API Reference',
    ...
    },
    {
      ...
      items: [{ type: 'autogenerated', dirName: '05-other' }],
    },
  ],
};
