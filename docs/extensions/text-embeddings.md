...
| **multi-qa-MiniLM / mpnet**               | [`MiniLM`](https://docs.swmansion.com/react-native-executorch/docs/api-reference/variables/models#textembeddingsmulti_qa_minilm_l6_cos_v1), [`mpnet`](https://docs.swmansion.com/react-native-executorch/docs/api-reference/variables/models#textembeddingsmulti_qa_mpnet_base_dot_v1) | 384 / 768  | English       | 86.2 MB – 415.6 MB  | XNNPACK (CPU), Core ML (Apple), Vulkan (Android)              | Fine-tuned specifically for Question-Answering retrieval.         |
