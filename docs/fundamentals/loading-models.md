...
### Load from React Native assets folder (for files < 512MB)[​](#load-from-react-native-assets-folder-for-files--512mb "Direct link to Load from React Native assets folder (for files < 512MB)")
...
### Load from remote URL[​](#load-from-remote-url "Direct link to Load from remote URL")
...
### Load from local file system[​](#load-from-local-file-system "Direct link to Load from local file system")
