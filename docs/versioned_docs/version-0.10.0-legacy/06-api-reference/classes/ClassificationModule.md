...
Defined in: [modules/computer_vision/ClassificationModule.ts:49](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/modules/computer_vision/ClassificationModule.ts#L49)
...
`T` _extends_ [`ClassificationModelName`](../type-aliases/ClassificationModelName.md) \| [`LabelEnum`](../type-aliases/LabelEnum.md)
...
Defined in: [modules/computer_vision/VisionModule.ts:61](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/modules/computer_vision/VisionModule.ts#L61)
...
> **forward**(`input`): `Promise`\<`Record`\<keyof `ResolveConfigOrType`\<`T`, \{ `efficientnet-v2-s`: \{ `labelMap`: _typeof_ [`Imagenet1kLabel`](../enumerations/Imagenet1kLabel.md); \}; `efficientnet-v2-s-quantized`: \{ `labelMap`: _typeof_ [`Imagenet1kLabel`](../enumerations/Imagenet1kLabel.md); \}; \}, `"labelMap"`\>, `number`\>\>

Defined in: [modules/computer_vision/ClassificationModule.ts:134](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/modules/computer_vision/ClassificationModule.ts#L134)
...
`Promise`\<`Record`\<keyof `ResolveConfigOrType`\<`T`, \{ `efficientnet-v2-s`: \{ `labelMap`: _typeof_ [`Imagenet1kLabel`](../enumerations/Imagenet1kLabel.md); \}; `efficientnet-v2-s-quantized`: \{ `labelMap`: _typeof_ [`Imagenet1kLabel`](../enumerations/Imagenet1kLabel.md); \}; \}, `"labelMap"`\>, `number`\>\>
...
Defined in: [modules/computer_vision/ClassificationModule.ts:108](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/modules/computer_vision/ClassificationModule.ts#L108)
...
Defined in: [modules/computer_vision/ClassificationModule.ts:65](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/modules/computer_vision/ClassificationModule.ts#L65)
