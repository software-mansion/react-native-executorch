...
Defined in: [types/llm.ts:196](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/types/llm.ts#L196)
...
`C` _extends_ readonly [`LLMCapability`](../type-aliases/LLMCapability.md)[] = readonly [`LLMCapability`](../type-aliases/LLMCapability.md)[]
...
> **sendMessage**: (`message`, `media?`) => `Promise`\<`string`\>

Defined in: [types/llm.ts:207](https://github.com/software-mansion/react-native-executorch/blob/0e95b8934cc7318c1b30a8e534444a8b50d25230/packages/react-native-executorch/src/types/llm.ts#L207)
...
[`MediaArg`](../type-aliases/MediaArg.md)\<`C`\>
