...
### Default model[​](#default-model "Direct link to Default model")
...
### Non-quantized variant[​](#non-quantized-variant "Direct link to Non-quantized variant")
...
### Explicit backend[​](#explicit-backend "Direct link to Explicit backend")
...
### Direct imports still work[​](#direct-imports-still-work "Direct link to Direct imports still work")
...
## Migration from the previous registry[​](#migration-from-the-previous-registry "Direct link to Migration from the previous registry")
