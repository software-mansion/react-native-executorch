...
### Module State Errors[​](#module-state-errors "Direct link to Module State Errors")
...
### Download & Resource Fetcher Errors[​](#download--resource-fetcher-errors "Direct link to Download & Resource Fetcher Errors")
...
### Model Execution Errors[​](#model-execution-errors "Direct link to Model Execution Errors")
...
### ExecuTorch Runtime Errors[​](#executorch-runtime-errors "Direct link to ExecuTorch Runtime Errors")
...
#### Logical Errors[​](#logical-errors "Direct link to Logical Errors")
...
#### Delegate Errors[​](#delegate-errors "Direct link to Delegate Errors")
