...
- Follow the official [tutorial](https://github.com/pytorch/executorch/tree/v1.1.0/examples/llm_manual) made by ExecuTorch team to build the model and tokenizer yourself.
