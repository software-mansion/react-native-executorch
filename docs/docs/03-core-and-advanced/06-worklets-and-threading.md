...
<ThemedImage
alt="Execution contexts and shared native C++ heap"
sources={{
    light: '/react-native-executorch/img/diagrams/execution-contexts.svg',
    dark: '/react-native-executorch/img/diagrams/execution-contexts-dark.svg',
  }}
/>
