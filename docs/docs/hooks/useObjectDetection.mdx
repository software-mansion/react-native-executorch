...
of the bounding box, the label of the detected object and confidence score. For more information, please refer to the reference or type definitions.
...
| `error`              | `string \| null`                     | Contains the error message if the model failed to load or encountered an error during the generation process.    |
