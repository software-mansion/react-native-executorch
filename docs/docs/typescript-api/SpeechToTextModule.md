...
| `decode`              | `(tokens: number[]) => Promise<number>`                                                                                                                                                                                                                                                                  | Runs the decoder of the model. Returns a single token representing a next token in the output. It uses internal cached encodings from previous `encode` call, meaning that you have to call `encode` prior to decoding.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
