...
> **useOCR**(`__namedParameters`): `OCRModule`

Defined in: [packages/react-native-executorch/src/hooks/computer\_vision/useOCR.ts:15](https://github.com/software-mansion/react-native-executorch/blob/98ccf0be60ddbbdcffa6085f633ea6ccfd6c68f2/packages/react-native-executorch/src/hooks/computer_vision/useOCR.ts#L15)
