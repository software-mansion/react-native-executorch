...
Defined in: [constants/modelUrls.ts:475](https://github.com/software-mansion/react-native-executorch/blob/main/packages/react-native-executorch/src/constants/modelUrls.ts#L475)
