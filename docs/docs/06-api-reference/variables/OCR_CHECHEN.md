...
Defined in: [packages/react-native-executorch/src/constants/ocr/models.ts:98](https://github.com/software-mansion/react-native-executorch/blob/98ccf0be60ddbbdcffa6085f633ea6ccfd6c68f2/packages/react-native-executorch/src/constants/ocr/models.ts#L98)
