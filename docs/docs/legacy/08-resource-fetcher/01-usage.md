...
await ExpoResourceFetcher.pauseFetching('https://.../lfm2_5.pte', 'https://.../tokenizer.json');
```
...
await ExpoResourceFetcher.cancelFetching('https://.../lfm2_5.pte', 'https://.../tokenizer.json');
```
