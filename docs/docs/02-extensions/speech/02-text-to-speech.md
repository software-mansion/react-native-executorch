...
| Model                          | Variants                                                                                              | Sub-Models & Assets                                                          | Sample Rate | Size (Total) | Supported Backends                           | Supported Languages                                                                                                                                                                | Notes                                                                                                                                                |
| :----------------------------- | :---------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------- | :---------- | :----------- | :------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Supertonic 3**               | [`models.textToSpeech.SUPERTONIC`](../../06-api-reference/variables/models.md#texttospeechsupertonic) | Text Encoder, Duration Predictor, Vector Estimator, Vocoder, Voice Styles    | 44.1 kHz    | 398 MB       | XNNPACK (CPU), MLX (Apple), Vulkan (Android) | [English, Spanish, French, German, Korean, Japanese, Chinese & more](../../06-api-reference/react-native-executorch/namespaces/speech/variables/SUPERTONIC_SUPPORTED_LANGUAGES.md) | High-fidelity multilingual flow-matching model with 10 bundled [speaker styles](../../06-api-reference/variables/SUPERTONIC_DEFAULT_VOICE_NAMES.md). |
| **Kokoro (Language Packages)** | [`models.textToSpeech.KOKORO`](../../06-api-reference/variables/models.md#texttospeechkokoro)         | Duration Predictor, Synthesizer, G2P Lexicon / Neural Model, Language Voices | 24.0 kHz    | 332 MB each  | XNNPACK (CPU), Core ML (Apple)               | English (US/GB), Spanish, French, Italian, Portuguese, Hindi, Polish, German                                                                                                       | Separate model packages per language with dedicated grapheme-to-phoneme assets and native voice presets.                                             |
