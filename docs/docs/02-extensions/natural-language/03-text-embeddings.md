...
| **multi-qa-MiniLM / mpnet**               | [See](../../06-api-reference/variables/models.md#textembeddingsmulti_qa_minilm_l6_cos_v1), [See](../../06-api-reference/variables/models.md#textembeddingsmulti_qa_mpnet_base_dot_v1) | 384 / 768  | English       | 86.2 MB – 415.6 MB  | XNNPACK (CPU), Core ML (Apple), Vulkan (Android)              | Fine-tuned specifically for Question-Answering retrieval.         |
