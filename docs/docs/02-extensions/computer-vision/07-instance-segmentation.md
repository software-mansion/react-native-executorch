...
| :------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------- | :----------------- | :----------------------------- | :---------------------------------------------------------------------------- |
| **FastSAM**          | [`models.instanceSegmentation.FASTSAM.S`](../../06-api-reference/variables/models.md#instancesegmentationfastsams), [`FASTSAM.X`](../../06-api-reference/variables/models.md#instancesegmentationfastsamx) | Open-world promptable masks | 23.1 MB – 275.7 MB | XNNPACK (CPU), Core ML (Apple) | Segment Anything Model optimized for zero-shot object mask extraction.        |
| **RF-DETR Nano Seg** | [`models.instanceSegmentation.RFDETR_NANO`](../../06-api-reference/variables/models.md#instancesegmentationrfdetr_nano)                                                                                    | COCO (80 classes)           | 59.5 MB – 118.3 MB | XNNPACK (CPU), Core ML (Apple) | DINOv2-based detection & instance segmentation transformer.                   |
| **YOLO26 Seg**       | [`models.instanceSegmentation.YOLO26`](../../06-api-reference/variables/models.md#instancesegmentationyolo26)                                                                                              | COCO (80 classes)           | 10.6 MB – 240.0 MB | XNNPACK (CPU), Core ML (Apple) | Real-time simultaneous object detection and polygon instance mask extraction. |
