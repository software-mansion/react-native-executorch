...
| :---------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :----------------- | :----------------------------- | :----------------------------------------------------------------------- |
| **Selfie Segmentation** | [See](../../06-api-reference/variables/models.md#semanticsegmentationselfie_segmentation), [See](../../06-api-reference/variables/models.md#semanticsegmentationselfie_segmentation_landscape)                                                                                             | Person / Background     | 0.5 MB – 0.6 MB    | XNNPACK (CPU), Core ML (Apple) | Real-time front-camera portrait background replacement and blur effects. |
| **LRASPP MobileNetV3**  | [See](../../06-api-reference/variables/models.md#semanticsegmentationlraspp_mobilenet_v3_large)                                                                                                                                                                                            | Pascal VOC (21 classes) | 3.4 MB – 12.3 MB   | XNNPACK (CPU), Core ML (Apple) | Lightweight multi-class scene segmentation with low CPU overhead.        |
| **DeepLabV3**           | [See](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_resnet50), [See](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_resnet101), [See](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_mobilenet_v3_large) | Pascal VOC (21 classes) | 40.4 MB – 223.6 MB | XNNPACK (CPU), Core ML (Apple) | High-fidelity dense pixel classification for complex scenes.             |
| **FCN**                 | [See](../../06-api-reference/variables/models.md#semanticsegmentationfcn_resnet50), [See](../../06-api-reference/variables/models.md#semanticsegmentationfcn_resnet101)                                                                                                                    | Pascal VOC (21 classes) | 34.0 MB – 198.1 MB | XNNPACK (CPU), Core ML (Apple) | Fully Convolutional Networks baseline for dense multi-class parsing.     |
...
- [See](../../06-api-reference/variables/PASCAL_VOC_LABELS.md) — List of 21 standard Pascal VOC class labels.
