...
| :---------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :----------------- | :----------------------------- | :----------------------------------------------------------------------- |
| **Selfie Segmentation** | [`models.semanticSegmentation.SELFIE_SEGMENTATION`](../../06-api-reference/variables/models.md#semanticsegmentationselfie_segmentation), [`SELFIE_SEGMENTATION_LANDSCAPE`](../../06-api-reference/variables/models.md#semanticsegmentationselfie_segmentation_landscape)                                                                                                                | Person / Background     | 0.5 MB – 0.6 MB    | XNNPACK (CPU), Core ML (Apple) | Real-time front-camera portrait background replacement and blur effects. |
| **LRASPP MobileNetV3**  | [`models.semanticSegmentation.LRASPP_MOBILENET_V3_LARGE`](../../06-api-reference/variables/models.md#semanticsegmentationlraspp_mobilenet_v3_large)                                                                                                                                                                                                                                     | Pascal VOC (21 classes) | 3.4 MB – 12.3 MB   | XNNPACK (CPU), Core ML (Apple) | Lightweight multi-class scene segmentation with low CPU overhead.        |
| **DeepLabV3**           | [`models.semanticSegmentation.DEEPLAB_V3_RESNET50`](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_resnet50), [`DEEPLAB_V3_RESNET101`](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_resnet101), [`DEEPLAB_V3_MOBILENET_V3_LARGE`](../../06-api-reference/variables/models.md#semanticsegmentationdeeplab_v3_mobilenet_v3_large) | Pascal VOC (21 classes) | 40.4 MB – 223.6 MB | XNNPACK (CPU), Core ML (Apple) | High-fidelity dense pixel classification for complex scenes.             |
| **FCN**                 | [`models.semanticSegmentation.FCN_RESNET50`](../../06-api-reference/variables/models.md#semanticsegmentationfcn_resnet50), [`FCN_RESNET101`](../../06-api-reference/variables/models.md#semanticsegmentationfcn_resnet101)                                                                                                                                                              | Pascal VOC (21 classes) | 34.0 MB – 198.1 MB | XNNPACK (CPU), Core ML (Apple) | Fully Convolutional Networks baseline for dense multi-class parsing.     |
