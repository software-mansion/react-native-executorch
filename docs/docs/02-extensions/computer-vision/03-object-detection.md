...
| :------------------------- | :--------------------------------------------------------------------------------------------- | :----------------- | :----------------------------- | :------------------- | :------------------------------------------------------------------------------------ |
| **SSDLite320 MobileNetV3** | [See](../../06-api-reference/variables/models.md#objectdetectionssdlite320_mobilenet_v3_large) | 8.1 MB – 13.3 MB   | XNNPACK (CPU), Core ML (Apple) | COCO (80 classes)    | Ultra-lightweight detector with highest frame rates on low-end devices.               |
| **RF-DETR Nano**           | [See](../../06-api-reference/variables/models.md#objectdetectionrfdetr_nano)                   | 52.2 MB – 106.4 MB | XNNPACK (CPU), Core ML (Apple) | COCO (80 classes)    | DINOv2-based detection transformer with superior small-object accuracy.               |
| **YOLO26**                 | [See](../../06-api-reference/variables/models.md#objectdetectionyolo26)                        | 5.4 MB – 212.9 MB  | XNNPACK (CPU), Core ML (Apple) | COCO (80 classes)    | Scalable real-time detection family across 384x384, 512x512, and 640x640 resolutions. |
