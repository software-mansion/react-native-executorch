...
| :------------------- | :---------------------------------------------------------------------------------------------------------------------- | :---------------- | :----------------------------- | :-------------------------- | :----------------------------------------------------------------- |
| **EfficientNetV2-S** | [`models.classification.EFFICIENTNET_V2_S`](../../06-api-reference/variables/models.md#classificationefficientnet_v2_s) | 21.9 MB – 81.7 MB | XNNPACK (CPU), Core ML (Apple) | ImageNet-1k (1,000 classes) | Fast, lightweight general image recognition and tagging on mobile. |
