...
class ExecutorchWebRTCModule(reactContext: ReactApplicationContext) :
    ...
    companion object {
        ...
        fun sendEvent(eventName: String, params: WritableMap?) {
            moduleContext?.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter::class.java)
    ...
    // Legacy alias
    @ReactMethod
    fun configureBackgroundBlur(modelPath: String, blurIntensity: Int) {
        ExecutorchWebRTC.configureModel(modelPath)
    }
}
