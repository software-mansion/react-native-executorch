 ...
 * @category Hooks
 */
export const useSemanticSegmentation = <C extends SemanticSegmentationModelSources>({
  model,
  preventLoad = false,
  ...
  ) => runForward((inst) => inst.forward(imageSource, classesOfInterest, resizeToInput));
