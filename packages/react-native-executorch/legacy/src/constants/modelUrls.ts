...
const RF_DETR_NANO_MODEL =
  Platform.OS === 'ios' ? RF_DETR_NANO_COREML_INT8_MODEL : RF_DETR_NANO_XNNPACK_FP32_MODEL;
 ...
 */
export function styleTransferUrls<const Display extends string, const Slug extends string>(
  display: Display,
  slug: Slug
) {
  return {
...
export const WHISPER_TINY_EN = {
  ...
  modelSource: Platform.OS === 'ios' ? WHISPER_TINY_EN_MODEL_COREML : WHISPER_TINY_EN_MODEL_XNNPACK,
...
export const WHISPER_BASE_EN = {
  ...
  isMultilingual: false,
  modelSource: Platform.OS === 'ios' ? WHISPER_BASE_EN_MODEL_COREML : WHISPER_BASE_EN_MODEL_XNNPACK,
...
export const WHISPER_SMALL_EN = {
  ...
  isMultilingual: false,
  modelSource:
    Platform.OS === 'ios' ? WHISPER_SMALL_EN_MODEL_COREML : WHISPER_SMALL_EN_MODEL_XNNPACK,
...
export const WHISPER_TINY = {
  ...
  isMultilingual: true,
  modelSource: Platform.OS === 'ios' ? WHISPER_TINY_MODEL_COREML : WHISPER_TINY_MODEL_XNNPACK,
...
export const WHISPER_BASE = {
  ...
  isMultilingual: true,
  modelSource: Platform.OS === 'ios' ? WHISPER_BASE_MODEL_COREML : WHISPER_BASE_MODEL_XNNPACK,
...
export const WHISPER_SMALL = {
  ...
  isMultilingual: true,
  modelSource: Platform.OS === 'ios' ? WHISPER_SMALL_MODEL_COREML : WHISPER_SMALL_MODEL_XNNPACK,
...
const RF_DETR_NANO_SEG_MODEL =
  Platform.OS === 'ios' ? RF_DETR_NANO_SEG_COREML_INT8_MODEL : RF_DETR_NANO_SEG_XNNPACK_FP32_MODEL;
/**
 * @category Models - Instance Segmentation
 */
