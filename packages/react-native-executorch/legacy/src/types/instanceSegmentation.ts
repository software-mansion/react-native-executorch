 ...
 * @category Types
 */
export type InstanceSegmentationModelName = InstanceSegmentationModelSources['modelName'];

/**
 * Extracts the instance segmentation model name from a {@link InstanceSegmentationModelSources} config object.
 * @category Types
 */
export type InstanceModelNameOf<C extends InstanceSegmentationModelSources> = C['modelName'];
 ...
 * @category Types
 */
export interface InstanceSegmentationProps<C extends InstanceSegmentationModelSources> {
  model: C;
  preventLoad?: boolean;
}
