 ...
 * @category Types
 */
export type PoseDetections<K extends LabelEnum = typeof CocoKeypoint> = PersonKeypoints<K>[];
...
export interface PoseEstimationType<K extends LabelEnum> {
   ...
   */
  runOnFrame:
    | ((frame: Frame, isFrontCamera: boolean, options?: PoseEstimationOptions) => PoseDetections<K>)
    | null;
}
