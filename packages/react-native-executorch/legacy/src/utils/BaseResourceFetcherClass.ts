 ...
 */
export abstract class BaseResourceFetcherClass<TDownload> implements ResourceFetcherAdapter {
  /**
   ...
   */
  protected abstract getFilesSizes(sources: ResourceSource[]): Promise<FilesSizesResult>;
