...
public:
     ...
     */
    ET_NODISCARD virtual ::executorch::runtime::Error load(const std::string &prefill_method,
     ...
     * @return Error code.
     */
    ET_NODISCARD ::executorch::runtime::Error load() { return load("forward", "forward"); }
     ...
     */
    ET_NODISCARD virtual ::executorch::runtime::Error reset(const std::string &prefill_method,
                                                            const std::string &decode_method) {
        (void)prefill_method;
        (void)decode_method;
        return ::executorch::runtime::Error::Ok;
     ...
     * @return Error code.
     */
    ET_NODISCARD ::executorch::runtime::Error reset() { return reset("forward", "forward"); }
     ...
     */
    virtual ::executorch::runtime::Result<std::vector<::executorch::runtime::EValue>>
    prepare_prefill(const TensorPtr &input, const TensorPtr &start_pos,
        ...
        // here.
        return std::vector<::executorch::runtime::EValue>{input, start_pos};
    }
     ...
     */
    ET_NODISCARD virtual ::executorch::runtime::Error
    update_prefill(const std::vector<::executorch::runtime::EValue> &model_outputs,
                   const std::string &prefill_method) {
        (void)model_outputs;
        (void)prefill_method;
     ...
     */
    ET_NODISCARD virtual ::executorch::runtime::Error
    update_decode(const std::vector<::executorch::runtime::EValue> &model_outputs,
                  const std::string &decode_method) {
        (void)model_outputs;
        (void)decode_method;
        // No post inference work to do.
