...
class ModelHostObject : public JsiHostObject {
public:
    ...
    template <auto FnPtr>
    JSI_HOST_FUNCTION(synchronousHostFunction) {
     ...
     */
    template <auto FnPtr>
    JSI_HOST_FUNCTION(visionHostFunction) {
    ...
    template <auto FnPtr>
    JSI_HOST_FUNCTION(promiseHostFunction) {
