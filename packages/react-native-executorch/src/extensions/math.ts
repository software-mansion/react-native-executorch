 ...
 * the result to a destination tensor.
 * @category Typescript API
 * @param src The input source tensor.
...
/**
 * Computes the softmax activation along a specified axis on a source tensor and
...
/**
 * Computes the indices of the maximum values along a specified axis on a source
