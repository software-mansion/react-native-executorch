...
# ============================================================================
MODELS=(
  "style_transfer_candy_xnnpack_fp32.pte|https://huggingface.co/software-mansion/react-native-executorch-style-transfer-candy/resolve/v0.9.0/xnnpack/style_transfer_candy_xnnpack_fp32.pte"
  "efficientnet_v2_s_xnnpack.pte|https://huggingface.co/software-mansion/react-native-executorch-efficientnet-v2-s/resolve/v0.9.0/xnnpack/efficientnet_v2_s_xnnpack_fp32.pte"
  "ssdlite320-mobilenetv3-large.pte|https://huggingface.co/software-mansion/react-native-executorch-ssdlite320-mobilenet-v3-large/resolve/v0.9.0/xnnpack/ssdlite320_mobilenet_v3_large_xnnpack_fp32.pte"
  "test_image.jpg|https://upload.wikimedia.org/wikipedia/commons/f/f8/Cat_in_tree03.jpg"
  "clip-vit-base-patch32-vision_xnnpack.pte|https://huggingface.co/software-mansion/react-native-executorch-clip-vit-base-patch32/resolve/v0.9.0/xnnpack/clip_vit_base_patch32_image_xnnpack_fp32.pte"
  "all-MiniLM-L6-v2_xnnpack.pte|https://huggingface.co/software-mansion/react-native-executorch-all-MiniLM-L6-v2/resolve/v0.9.0/xnnpack/all_minilm_l6_v2_xnnpack_fp32.pte"
  "tokenizer.json|https://huggingface.co/software-mansion/react-native-executorch-all-MiniLM-L6-v2/resolve/v0.9.0/tokenizer.json"
  "fsmn-vad_xnnpack.pte|https://huggingface.co/software-mansion/react-native-executorch-fsmn-vad/resolve/v0.9.0/xnnpack/fsmn_vad_xnnpack_fp32.pte"
  "whisper_tiny_en_xnnpack.pte|https://huggingface.co/software-mansion/react-native-executorch-whisper-tiny.en/resolve/v0.9.0/xnnpack/whisper_tiny_en_xnnpack_fp32.pte"
  "whisper_tokenizer.json|https://huggingface.co/software-mansion/react-native-executorch-whisper-tiny.en/resolve/v0.9.0/tokenizer.json"
  ...
  "smolLm2_135M_8da4w.pte|https://huggingface.co/software-mansion/react-native-executorch-smolLm-2/resolve/v0.9.0/135m/xnnpack/smollm2_135m_xnnpack_8da4w.pte"
  "smollm_tokenizer.json|https://huggingface.co/software-mansion/react-native-executorch-smolLm-2/resolve/v0.9.0/tokenizer.json"
  "deeplabV3_xnnpack_fp32.pte|https://huggingface.co/software-mansion/react-native-executorch-deeplab-v3/resolve/v0.9.0/xnnpack/deeplab_v3_resnet50_xnnpack_fp32.pte"
  "xnnpack_crnn_english.pte|https://huggingface.co/software-mansion/react-native-executorch-recognizer-crnn.en/resolve/v0.9.0/english/xnnpack/crnn_english_xnnpack_fp32.pte"
  "xnnpack_craft_quantized.pte|https://huggingface.co/software-mansion/react-native-executorch-detector-craft/resolve/v0.9.0/xnnpack/craft_xnnpack_int8.pte"
  "t2i_tokenizer.json|https://huggingface.co/software-mansion/react-native-executorch-bk-sdm-tiny/resolve/v0.9.0/tokenizer/tokenizer.json"
  "t2i_encoder.pte|https://huggingface.co/software-mansion/react-native-executorch-bk-sdm-tiny/resolve/v0.9.0/xnnpack/bk_sdm_tiny_text_encoder_xnnpack_fp32.pte"
  "t2i_unet.pte|https://huggingface.co/software-mansion/react-native-executorch-bk-sdm-tiny/resolve/v0.9.0/xnnpack/bk_sdm_tiny_unet_256_xnnpack_fp32.pte"
  "t2i_decoder.pte|https://huggingface.co/software-mansion/react-native-executorch-bk-sdm-tiny/resolve/v0.9.0/xnnpack/bk_sdm_tiny_vae_256_xnnpack_fp32.pte"
  "lfm2_5_vl_quantized_xnnpack_v2.pte|https://huggingface.co/software-mansion/react-native-executorch-lfm-2.5/resolve/v0.9.0/vl_1_6b/xnnpack/lfm_2_5_vl_1_6b_xnnpack_8da4w.pte"
  "lfm2_vl_tokenizer.json|https://huggingface.co/software-mansion/react-native-executorch-lfm-2.5/resolve/v0.9.0/vl_1_6b/tokenizer.json"
  "lfm2_vl_tokenizer_config.json|https://huggingface.co/software-mansion/react-native-executorch-lfm-2.5/resolve/v0.9.0/vl_1_6b/tokenizer_config.json"
  "yolo26n-seg.pte|https://huggingface.co/software-mansion/react-native-executorch-yolo26-seg/resolve/v0.9.0/n/xnnpack/yolo26_seg_n_xnnpack_fp32.pte"
