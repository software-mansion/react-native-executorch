...
private:
  ...
  constexpr static leaf_layout_type
  LeafLayout(const size_type slot_count = kNodeSlots) {
...
public:
  ...
  template <typename K>
  SearchResult<size_type, is_key_compare_to::value>
  ...
  template <typename K, typename Compare>
  SearchResult<size_type, false>
  linear_search_impl(const K &k, size_type s, const size_type e,
                     const Compare &comp,
  ...
  template <typename K, typename Compare>
  SearchResult<size_type, false>
  binary_search_impl(const K &k, size_type s, size_type e, const Compare &comp,
                     std::false_type /* IsCompareTo */) const {
    while (s != e) {
  ...
  SearchResult<size_type, true>
  binary_search_impl(const K &k, size_type s, size_type e,
...
public:
  ...
  btree_iterator(const btree_iterator<N, R, P> other) // NOLINT
      : btree_iterator_generation_info(other), node_(other.node_),
...
private:
  ...
  template <typename K>
  SearchResult<iterator, is_key_compare_to::value>
  internal_lower_bound(const K &key) const;
