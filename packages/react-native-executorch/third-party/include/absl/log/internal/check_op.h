...
ABSL_ATTRIBUTE_PURE_FUNCTION absl::Nonnull<const char *>
MakeCheckFailString(absl::Nonnull<const absl::Status *> status,
...
ABSL_ATTRIBUTE_RETURNS_NONNULL absl::Nonnull<const char *>
MakeCheckOpString(T1 v1, T2 v2,
                  absl::Nonnull<const char *> exprtext) ABSL_ATTRIBUTE_NOINLINE;

template <typename T1, typename T2>
absl::Nonnull<const char *>
MakeCheckOpString(T1 v1, T2 v2, absl::Nonnull<const char *> exprtext) {
...
absl::Nullable<const char *>
CheckstrcmptrueImpl(absl::Nullable<const char *> s1,
                    absl::Nullable<const char *> s2,
                    absl::Nonnull<const char *> exprtext);
absl::Nullable<const char *>
CheckstrcmpfalseImpl(absl::Nullable<const char *> s1,
                     absl::Nullable<const char *> s2,
                     absl::Nonnull<const char *> exprtext);
absl::Nullable<const char *>
CheckstrcasecmptrueImpl(absl::Nullable<const char *> s1,
                        absl::Nullable<const char *> s2,
                        absl::Nonnull<const char *> exprtext);
absl::Nullable<const char *>
CheckstrcasecmpfalseImpl(absl::Nullable<const char *> s1,
                         absl::Nullable<const char *> s2,
                         absl::Nonnull<const char *> exprtext);
...
GetReferenceableValue(unsigned long long t) {
  return t;
}
