...
public:
  ...
  LogMessage &
  operator<<(absl::Nonnull<std::ios_base &(*)(std::ios_base & os)> m);
  ...
  template <typename T, typename std::enable_if<
                            absl::HasAbslStringify<T>::value, int>::type = 0>
...
LogMessage::operator<<(absl::Nullable<void *> const &v);
extern template LogMessage &
LogMessage::operator<<(absl::Nullable<const void *> const &v);
...
extern template void
LogMessage::CopyToEncodedBuffer<LogMessage::StringType::kNotLiteral>(
    absl::string_view str);
extern template void
