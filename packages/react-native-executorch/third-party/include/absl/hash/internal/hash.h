...
typename std::enable_if<std::is_same<B, bool>::value, H>::type
...
typename std::enable_if<std::is_enum<Enum>::value, H>::type
...
template <typename H, typename T, size_t N>
typename std::enable_if<is_hashable<T>::value, H>::type
...
typename std::enable_if<is_hashable<Key>::value, H>::type
...
template <typename H, typename T>
typename std::enable_if<is_hashable<T>::value, H>::type
AbslHashValue(H hash_state, std::reference_wrapper<T> opt) {
...
private:
  ...
  private:
    template <typename H,
              typename = decltype(H::Invoke(std::declval<State>(),
                                            std::declval<const T &>()))>
