...
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering
...
ABSL_ATTRIBUTE_PURE_FUNCTION constexpr Duration
...
ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::nanoseconds
ToChronoNanoseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::microseconds
ToChronoMicroseconds(Duration d);
ABSL_ATTRIBUTE_CONST_FUNCTION std::chrono::milliseconds
ToChronoMilliseconds(Duration d);
...
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration
MakeNormalizedDuration(int64_t sec, int64_t ticks) {
...
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr int64_t
NegateAndSubtractOne(int64_t n) {
...
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v,
  ...
  return MakeNormalizedDuration(v / N, v % N * kTicksPerNanosecond * 1000 *
                                           1000 * 1000 / N);
}
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v,
                                                           std::ratio<60>) {
...
ABSL_ATTRIBUTE_CONST_FUNCTION constexpr Duration operator-(Duration d) {
  ...
  return time_internal::GetRepLo(d) == 0
         ...
         : time_internal::IsInfiniteDuration(d)
             ...
             : time_internal::MakeDuration(time_internal::NegateAndSubtractOne(
                                               time_internal::GetRepHi(d)),
