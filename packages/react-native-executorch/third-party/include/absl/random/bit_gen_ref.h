...
public:
  ...
  BitGenRef(URBGRef &&gen ABSL_ATTRIBUTE_LIFETIME_BOUND) // NOLINT
      : t_erased_gen_ptr_(reinterpret_cast<uintptr_t>(&gen)),
        mock_call_(NotAMock), generate_impl_fn_(ImplFn<URBG>) {}
  ...
  BitGenRef(URBGRef &&gen ABSL_ATTRIBUTE_LIFETIME_BOUND) // NOLINT
      : t_erased_gen_ptr_(reinterpret_cast<uintptr_t>(&gen)),
        mock_call_(&MockCall<URBG>), generate_impl_fn_(ImplFn<URBG>) {}
...
private:
  ...
  using mock_call_fn = bool (*)(uintptr_t, base_internal::FastTypeIdType,
                                void *, void *);
  ...
  static bool NotAMock(uintptr_t, base_internal::FastTypeIdType, void *,
                       void *) {
    return false;
  }
