...
poisson_distribution<IntType>::operator()(URBG &g, // NOLINT(runtime/references)
                                          const param_type &p) {
...
operator<<(std::basic_ostream<CharT, Traits> &os, // NOLINT(runtime/references)
...
operator>>(std::basic_istream<CharT, Traits> &is, // NOLINT(runtime/references)
