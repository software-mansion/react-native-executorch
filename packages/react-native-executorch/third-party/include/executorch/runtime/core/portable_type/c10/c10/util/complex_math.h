...
C10_HOST_DEVICE inline thrust::complex<float>
complex_mul_fma(thrust::complex<float> a, thrust::complex<float> b) {
...
template <>
C10_HOST_DEVICE inline c10::complex<float> pow(const c10::complex<float> &x,
